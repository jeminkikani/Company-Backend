...
const {registerUser,loginuser,getuser,getallUser,updateuser,deleteUser,} = require("../controllar/user.controllar");
...
// updateuser
userRoutes.put("/update-user",isveryfy, validationConstant('update') ,updateuser);
